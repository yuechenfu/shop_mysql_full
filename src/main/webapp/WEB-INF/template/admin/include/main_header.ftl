	...
	<ul class="nav pull-right">
		...
		<li class="dropdown">
			...
			<ul class="dropdown-menu dropdown-menu-right">
				<li>
					<a href="http://www.shopxx.net" target="_blank">${message("admin.mainHeader.official")}</a>
				</li>
				<li>
					<a href="http://www.shopxx.net/about.html" target="_blank">${message("admin.mainHeader.about")}</a>
				</li>
			</ul>
		</li>
		<li>
